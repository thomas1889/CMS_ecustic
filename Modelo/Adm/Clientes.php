                ...
                <section class="posts col-md-12">
                    ...
                    <article class="post clearfix">
                        ...
                        <section>
                            ...
                            <table>
                                <tr>
                                    <td>
                                        <h2>Edite el  texto de la página de <span style="color:red;">Clientes</span></h2> 
                                    </td>
                                    <td style="text-align: right;">
                                        <h2>
                                            un Nuevo cliente, pulse 
                                            <a href="controlador/insertarNuevaImg.php">
                            ...
                            while ($texto = mysql_fetch_array($query)) {
                                ...
                                //. "<td><input type='button' class='btn btn-danger' name='borrar' id='borrar' onclick='borrar(" . $texto['idCliente'] . ");' value=\"Borrar\"></td>"
                                . "</tr>";
                            }
                            echo "</table>";
                            ?>
                            ...
                            <form id="form3" name="form3" method="POST" action="controlador/borrarCliente.php">
                    ...
                    <article class="post clearfix">
                        ...
                        <section>
                            ...
                            <form id="form5" name="form5" method="POST" action="controlador/borrarCliente.php">
                                <input type="hidden" id="Borrarcodigo" name="Borrarcodigo">
                            </form>
                        </section>
