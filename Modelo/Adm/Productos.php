                ...
                <section class="posts col-md-12">
                    ...
                    <article class="post clearfix">
                        ...
                        <section>
                            ...
                            <h2>Edite los  textos de la página de <span style="color:red;">Paneles Acusticos.</span></h2><br/><br/>
                            <?php
                    ...
                    <article class="post clearfix">
                        ...
                        <section>
                            ...
                            <h2>Edite las imágenes de la página de <span style="color:red;">Paneles Acusticos</span></h2><br/><br/>
                            <?php
                    ...
                    <article class="post clearfix">
                        ...
                        <section>
                            ...
                            <h2>Edite los textos de la página de <span style="color:red;">Espumas Acusticas.</span></h2><br/><br/>
                            <?php
                            $sql = "select id_texto, titulo, tipo, contenido
                                from texto
                            ...
                            <form id="form4" name="form4" method="POST" action="controlador/editarTexto.php">
                                <input type="hidden" id="id_texto" name="id_texto">
                            </form>

                            <form id="form5" name="form5" method="POST" action="controlador/borrarTexto.php">
                                <input type="hidden" id="BorrarCodigo" name="BorrarCodigo">
                            </form>
                        </section>
                    ...
                    <article class="post clearfix">
                        ...
                        <section>
                            ...
                            <h2>Edite las imágenes de la página de <span style="color:red;">Espumas Acusticas</span></h2><br/><br/>
                            <?php
                            $sql = "select id_imagen, nombre, ubicacion
                                from imagen
                            ...
                            --<form id="form6" name="form4" method="POST" action="controlador/editarImagen.php">
                                <input type="hidden" id="id_imagen" name="id_imagen">
                            </form>
