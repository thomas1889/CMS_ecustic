                ...
                <section class="posts col-md-12">
                    ...
                    <article class="post clearfix">
                        ...
                        <section>
                            ...
                            <?php
                            $sql = "SELECT articulos.*, imagen.id_imagen, imagen.ubicacion
                                    FROM articulos
                            ...
                            while ($texto = mysql_fetch_array($query)) {
                                ...
                                . "<td>" . $texto['preview'] . "<br><br>"
                                . "<td>" . $texto['cabezote'] . "</td>"
                                . "<td><img width='90%' height='auto' src='../../Assets/Img/pag/" . $texto['ubicacion'] . "'><br><br><input type='button' class='btn btn-warning' name='editar' id='editar' onclick='editar2(" . $texto['id_imagen'] . ");' value=\"Cambiar Imagen\"></td>"
                                . "<td>" . $texto['fecha'] . "</td>"
                                . "<td>" . $texto['archivo'] . "<br><br><input type='button' class='btn btn-info' name='editar' id='editar' onclick='editar3(" . $texto['id_art'] . ");' value=\"Editar Texto del Articulo\"></td>"
                                . "</tr>";
                            }
                            echo "</table>";
                            ?>
