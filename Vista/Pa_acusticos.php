...
<html lang="es">
    <head>
        ...
        <title>Productos > Paneles Acústicos</title>
    </head>
    <body>
        ...
        <div class="row-fluid">
            ...
            <div class="row">
                ...
                <div class="col-md-8" id="div1">
                    <h1 class="titulos">Productos > Paneles Acústicos</h1>
                    <img src="../Assets/Img/resources/linea.png" width="100%">
                    
                    
                        <img  src="../Assets/Img/pag/<?php echo $imagenes[34]['ubicacion']; ?>" style="max-width:100%;max-height:20em;">
                        <img  src="../Assets/Img/pag/<?php echo $imagenes[35]['ubicacion']; ?>" style="max-width:100%;max-height:20em;padding-left:2em;padding-right:2em;">
                        <img  src="../Assets/Img/pag/<?php echo $imagenes[36]['ubicacion']; ?>" style="max-width:100%;max-height:20em;">
                    
                    <article class="textos">
                        <h2><?php echo $contenido[40]['contenido'];?></h2><br/>
                        <p name="panel" id="panel"><?php echo $contenido[41]['contenido'];?></p>

                        <p>
                            <?php echo $contenido[42]['contenido'];?>
                        </p>

                        <p> <?php echo $contenido[43]['contenido'];?>
                        </p><br/>
                        <p>
                       <?php echo $contenido[44]['contenido'];?>
                        </p>
                        <p>
                        <?php echo $contenido[45]['contenido'];?>
                        </p>
                    </article>
                </div>
                ...
                <img src="../Assets/Img/resources/linea_2.png" width="100%">
                    <footer>
                        <div class="row">
                            ...
                            <div class="col-md-8">
                                <div class="logfoot">
                                    <img id="stimg" name="stimg" src="../Assets/Img/resources/EMPRENDERBN.png" width="180px" height="auto">
