    ...
    <body>
        ...
        <div class="row-fluid">
            <div class="row">
                ...
                <div class="col-md-8">
                    <a href="../index.php"><img class="logo" name src="../Assets/Img/resources/<?php echo $imagenes[4]['ubicacion']; ?>" title="Logo_Ecustic"></a>
            ...
            <div class="row">
                ...
                <div class="col-md-8" id="div1">
                    <h1 class="titulos" name="empresa" id="empresa">Empresa</h1>
                    <img src="../Assets/Img/resources/linea.png" width="100%">
                    <img src="../Assets/Img/pag/<?php echo $imagenes[27]['ubicacion']; ?>" style="width:100%; height:auto;">
                    <article class="textos" >
                        <p><?php echo $contenido[7]['contenido'];?></p><br>
 
                        <p><?php echo $contenido[8]['contenido'];?></p><br>

                        <p><?php echo $contenido[9]['contenido'];?></p><br>

                        <p><?php echo $contenido[10]['contenido'];?></p><br>

                        <p><?php echo $contenido[11]['contenido'];?></p><br>
