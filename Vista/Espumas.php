...
<html lang="es">
    <head>
        ...
        <title>Productos > Espumas Acústicas</title>
    </head>
    <body>
        ...
        <div class="row-fluid">
            ...
            <div class="row">
                ...
                <div class="col-md-8" id="div1">
                    <h1 class="titulos">Productos > Espumas Acústicas </h1>
                   <img src="../Assets/Img/resources/linea.png" width="100%">

                   <img  src="../Assets/Img/pag/<?php echo $imagenes[30]['ubicacion']; ?>" style="max-width:100%;height:auto;">
                    <img  src="../Assets/Img/pag/<?php echo $imagenes[31]['ubicacion']; ?>" style="max-width:100%;height:auto;">
                    <img  src="../Assets/Img/pag/<?php echo $imagenes[32]['ubicacion']; ?>" style="max-width:100%;height:auto;">
                    <img  src="../Assets/Img/pag/<?php echo $imagenes[33]['ubicacion']; ?>" style="max-width:100%;height:auto;">
                    
                    <article class="textos">
                        <h2 ><?php echo $contenido[46]['contenido'];?></h2>
                        <p name="espumas" id="espumas"><?php echo $contenido[47]['contenido'];?></p>

                        <p>
                            <?php echo $contenido[48]['contenido'];?>
                        </p>

                        <p> 
                            <?php echo $contenido[49]['contenido'];?>
                        </p>
                        <p>
                            <?php echo $contenido[50]['contenido'];?><br/>
                           <?php echo $contenido[51]['contenido'];?><br/>
                        </p>
                        <p>
                           <?php echo $contenido[52]['contenido'];?>
                        </p>
                        <p><?php echo $contenido[53]['contenido'];?><br/>
                            <?php echo $contenido[54]['contenido'];?>
                        </p>
                        <p>
                           <?php echo $contenido[55]['contenido'];?>
                        </p>
                    </article>
                </div>
