        ...
        <div class="row-fluid">
            ...
            <div class="row">
                ...
                <div class="col-md-8" id="div1">
                    ...
                    <h1>Resultados de busqueda para: <strong><?php echo $palabra; ?></strong></h1>

                    <?php
                    $sql = "SELECT contenido, url FROM texto WHERE contenido LIKE '%" . $palabra . "%'";

                    $query = mysql_query($sql) or die(mysql_error());

                    echo "<table class='table table-hover' style='text-align:justify;'>";
                    echo "<tr>"
                    . "<td><strong>" . $palabra . "</strong> aparece en:</td>"
                    . "<td>Ver</td>"
                    . "</tr>";
                    ...
                    while ($texto = mysql_fetch_assoc($query)) {
                        echo
                        "<tr>"
                        . "<td><br><br>" . $texto['contenido'] . "<br><br></td>"
                        . "<td><br><br><a href='" . $texto['url'] . "'><input type='button' class='btn btn-info' name='Ver' id='Ver'  value=\"Ver Resultado\"></a><br><br></td>"
                        . "</tr>";
                    }
                    echo "</table>";
                    ?>
