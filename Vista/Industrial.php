...
<html lang="es">
    <head>
        ...
        <title>Acústica Industrial</title>
    </head>
    <body>
           ...
           <div class="row">
            ...
            <div class="row">
                ...
                <div class="col-md-8" id="div1">
                    <h1 class="titulos">Acústica Industrial</h1>
                    <img src="../Assets/Img/resources/linea_3.png" width="100%">
                    <img  src="../Assets/Img/pag/<?php echo $imagenes[38]['ubicacion']; ?>" style="max-width:100%;height:auto;">
                    <article class="textos">
                        <p class="arquitectonicaTexto"><?php echo $contenido[28]['contenido'];?></p>
                        <p><?php echo $contenido[29]['contenido'];?></p>

                        <p><?php echo $contenido[30]['contenido'];?></p>

                        <p><?php echo $contenido[31]['contenido'];?></p>
                        <p><?php echo $contenido[32]['contenido'];?></p>
                        <p><?php echo $contenido[33]['contenido'];?></p>
                        <p><?php echo $contenido[34]['contenido'];?></p>
                        <p><?php echo $contenido[35]['contenido'];?></p>
                        <p><?php echo $contenido[36]['contenido'];?></p>
                        <p><?php echo $contenido[37]['contenido'];?></p>
                        <p><?php echo $contenido[38]['contenido'];?></p>
                        <p><?php echo $contenido[39]['contenido'];?></p>
