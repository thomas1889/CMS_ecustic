...
<html lang="es">
    <head>
        ...
        <title>Acústica Ambiental</title>
        ...
        <div class="row-fluid">
                ...
                <div class="col-md-8">
                    <div class="redes">
                        ...
                        <div class="buscar">
                            ...
                            <form id="buscador" name="buscador" action="#" method="POST">
                                <br/>
                                <a href="#" target="_blank"><img class="search" src="../Assets/Img/complements/search.png" name="" id="" alt="Buscar" title="Buscar"></a>
            ...
            <div class="row">
                ...
                <div class="col-md-8" id="div1">
                    <h1 class="titulos">Acústica Ambiental</h1>
                    <img src="../Assets/Img/resources/linea_3.png" width="100%">
                    <img  src="../Assets/Img/pag/<?php echo $imagenes[28]['ubicacion']; ?>" style="max-width:100%;height:auto;">
                    <article class="textos">
                        <p class="arquitectonicaTexto" name="Aambiental" id="Aambiental"><?php echo $contenido[20]['contenido'];?></p>
                        <p><?php echo $contenido[21]['contenido'];?></p>

                        <p><?php echo $contenido[22]['contenido'];?><p> 
                           <?php echo $contenido[66]['contenido'];?></p><br/>
                        <p><?php echo $contenido[23]['contenido'];?></p><br/>
                        <p><?php echo $contenido[24]['contenido'];?></p>
                        <p><?php echo $contenido[25]['contenido'];?></p>
                        <p><?php echo $contenido[26]['contenido'];?></p>
                        <p><?php echo $contenido[27]['contenido'];?></p>
            ...
            <div class="row">
                ...
                <div class="col-md-8" id="div1">
                    <img src="../Assets/Img/resources/linea_2.png" width="100%" height="auto">
                    <footer>
                        <div class="row">
                            <div class="col-md-4">
                                <div class="contactos">
